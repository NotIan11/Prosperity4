...
PRODUCTS = {
    ...
    "PEBBLES_XS": trend_round5(DirectionalStrategy("PEBBLES_XS", 10, direction=-1)),  # drift −3962
    "PEBBLES_S":  trend_round5(DirectionalStrategy("PEBBLES_S",  10, direction=-1)),  # drift −1934
    ...
    "MICROCHIP_OVAL":      trend_round5(DirectionalStrategy("MICROCHIP_OVAL",      10, direction=-1)),  # drift −4481
    "MICROCHIP_TRIANGLE":  trend_round5(DirectionalStrategy("MICROCHIP_TRIANGLE",  10, direction=-1)),  # drift −2058
    ...
    "TRANSLATOR_SPACE_GRAY":  trend_round5(DirectionalStrategy("TRANSLATOR_SPACE_GRAY",  10, direction=-1)),  # drift −1571
    ...
    "PANEL_1X2": trend_round5(DirectionalStrategy("PANEL_1X2", 10, direction=-1)),  # drift −304
    ...
    "SNACKPACK_PISTACHIO": trend_round5(DirectionalStrategy("SNACKPACK_PISTACHIO", 10, direction=-1)),  # drift −887

    # UV_VISOR
    "UV_VISOR_AMBER":  trend_round5(DirectionalStrategy("UV_VISOR_AMBER",  10, direction=-1)),  # drift −2870
    ...
    "GALAXY_SOUNDS_SOLAR_FLAMES": trend_round5(DirectionalStrategy("GALAXY_SOUNDS_SOLAR_FLAMES", 10, direction=+1)),  # drift  +823
    ...
    "SLEEP_POD_SUEDE":      trend_round5(DirectionalStrategy("SLEEP_POD_SUEDE",      10, direction=+1)),  # drift +1800
    "SLEEP_POD_COTTON":     trend_round5(DirectionalStrategy("SLEEP_POD_COTTON",     10, direction=+1)),  # drift +1414
    "SLEEP_POD_LAMB_WOOL":  trend_round5(DirectionalStrategy("SLEEP_POD_LAMB_WOOL",  10, direction=+1)),  # drift  +808

    # UV_VISOR
    "UV_VISOR_RED":     trend_round5(DirectionalStrategy("UV_VISOR_RED",     10, direction=+1)),  # drift +1722
    ...
    # TRANSLATOR
    "TRANSLATOR_VOID_BLUE": trend_round5(DirectionalStrategy("TRANSLATOR_VOID_BLUE", 10, direction=+1)),  # drift +1564
