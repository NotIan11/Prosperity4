...
| v14 | v12 + 1000-tick adverse-move stop-loss on every directional. | +$1,097,228 | $49,267 | Codex independent BT showed universal 1000-tick stops are net-negative across full R5 (-$2k), first-100k slice (-$16k), and live replay (-$3k). Win concentrated in MICROCHIP_SQUARE day-4; cost spread across 8 products. Superseded by v15. |
| v15 | v14 with stops kept ONLY on PEBBLES_XL and MICROCHIP_SQUARE — the 2 products with documented full-day reversals >1000 ticks in capsule. Other 23 directionals lose stops. | +$1,103,278 | (live tbd) | Highest capsule BT of all candidates. +$4k vs Ian v25, +$6k vs v14. Surgical: keeps protection where evidence exists, drops it where codex showed cost. **Active submission.** |
