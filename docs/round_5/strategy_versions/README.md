...
| v13 | Ian v16 unchanged (= teammate's $62.6k live submission). 26 bare/delay-gated directionals + 18 EMA-MM, with several products turned off via take_edge=10000. | +$1,010,444 | (Ian's was $62,618) | **Active submission.** Ian v16's product config (more conservative "off" list) outperforms v25's. v25's "improvements" (slower EMAs, demoted directionals, RASPBERRY activated) cost ~$10k live. Ship the proven template. |
