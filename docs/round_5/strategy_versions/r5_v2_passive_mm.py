"""IMC Prosperity 4 — Round 5 trader (v2: passive MM).
...
class PebblesCoordinator:
    ...
    def __init__(self) -> None:
        self.makers: dict[str, PassiveMM] = {
            s: PassiveMM(s, skew=0.4, soft_cap=8, window=500, stop_loss_ticks=40.0)
...
PER_PRODUCT_CFG: dict[str, dict[str, Any]] = {
    # SNACKPACK (wide ~17 spreads, MM opportunity)
    "SNACKPACK_CHOCOLATE":  {"skew": 0.5, "soft_cap": 7, "stop_loss_ticks": 50.0},
    "SNACKPACK_VANILLA":    {"skew": 0.5, "soft_cap": 7, "stop_loss_ticks": 50.0},
    "SNACKPACK_STRAWBERRY": {"skew": 0.5, "soft_cap": 7, "stop_loss_ticks": 50.0},
    "SNACKPACK_RASPBERRY":  {"skew": 0.5, "soft_cap": 7, "stop_loss_ticks": 50.0},
    "SNACKPACK_PISTACHIO":  {"skew": 0.5, "soft_cap": 7, "stop_loss_ticks": 50.0},
    # Step-fn products: tighter skew, smaller stop (step=10 grid)
    "ROBOT_IRONING":               {"skew": 0.6, "soft_cap": 8, "stop_loss_ticks": 25.0},
    "OXYGEN_SHAKE_EVENING_BREATH": {"skew": 0.6, "soft_cap": 8, "stop_loss_ticks": 30.0},
}
