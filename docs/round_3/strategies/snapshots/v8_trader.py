...
v8: HYDROGEL strategy ported from teammate Ian (data/teammate_logs/ian2/
471212.py). Aggressive take + passive MM + trailing-drawdown derisk.
Replaces our v7 passive-only HG (which made 23k/3-day BT vs Ian's 108k).

Other products unchanged from v7:
- VFE: passive MM with asymmetric edges + L1-L2 skew.
- VEV_5300/5400: bias-aware passive MM.
"""
