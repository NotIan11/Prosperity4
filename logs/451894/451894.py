...
class HydrogelStrategy(Strategy):
    """
    HYDROGEL_PACK mean-reversion + trend guard around fair value 10,000.
    ...
    def run(self, state: TradingState) -> List[Order]:
        ...
        if trend == -1:
            ...
            sell_thr = self.FAIR_VALUE + self.TAKE_EDGE
            ...
            buy_cap = self.position_limit - pos - buys
            if buy_cap > 0:
                passive_bid_px = self.FAIR_VALUE - self.PASSIVE_SPREAD
