...
class HydrogelStrategy(Strategy):
    ...
    Empirically (3 days of round-3 data): +~57K/day with ENTRY_THR=20.
    """

    # Anchor FV — HYDROGEL_PACK prices are centred on 10,000 across all observed days
    FV: float = 10_000.0
    # Open / flip threshold: take when |mid - FV| > this
