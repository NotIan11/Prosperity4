...
class PassiveMarketMaker:
    ...
    def __init__(self, symbol: str, position_limit: int,
                 ...
                 bid_edge: int | None = None, ask_edge: int | None = None) -> None:
        self.symbol = symbol
    ...
    def run(self, state: TradingState) -> list[Order]:
        ...
        bid_px = int(round(fair - self.bid_edge - skew))
        ask_px = int(round(fair + self.ask_edge - skew))
    ...
    def __init__(self) -> None:
        ...
        self.strategies = {
            ...
            "VELVETFRUIT_EXTRACT": PassiveMarketMaker(
                ...
                bid_edge=2, ask_edge=3,  # v2: defensive vs informed buy-flow
            ),
